...
In 2002, the states with 7 or more locations were CT, FL, MA, NC, NJ, and PA. In 2010, the states with 7 or more locations were CA, CO, FL, MA, MD, NC, NE, NJ, NY, OH, PA, SC, TX, and WA.

Constructing a data set limited to "Excellent" responses, containing year, state, and a variable that averages data_value across locations within state. Making a spaghetti plot of this average value of time within a state.
