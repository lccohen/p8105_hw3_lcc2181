...
*Using the `group_by` function to group by aisle_id
*Using the `summarize` function to summarize the total number of observations by aisle_id, assuming each observation in the dataset represents an item ordered. 
...
*Using `group_by` to group by aisle_id
