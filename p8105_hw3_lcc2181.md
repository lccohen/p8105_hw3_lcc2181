...
aisles, limited to only aisles in which over 10,000 items were ordered.
There are two aisles that appear to be outliers as they have a much
greater numer of items ordered in those aisles compared with any other
aisle (for both of these aisles, the number of items ordered is over
140,000).
...
Applies are ordered is earlier than the mean hour of the day in which
